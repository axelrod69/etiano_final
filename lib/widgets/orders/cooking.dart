...
class Cooking extends StatefulWidget {
  CookingState createState() => CookingState();
}

class CookingState extends State<Cooking> {
  final Map<String, dynamic> _cooking = {
    'data': [
      {
        'id': 1,
        'name': 'Pizza Corner',
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: ListView.builder(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                    '(${_cooking['data'][index]['totalRatings'].toString()} ratings)',
                                                    textScaleFactor: textScale,
                                                    style: const TextStyle(
                                                        color: Colors.white,
                                                        fontSize: 12))
            ...
            itemCount: _cooking['data'].length),
      ),
    );
  }
}
