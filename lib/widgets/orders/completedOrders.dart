...
class CompletedOrdersState extends State<CompletedOrders> {
  final Map<String, dynamic> _completedOrders = {
    'data': [
      {
        'id': 1,
        'name': 'Pizza Corner',
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: ListView.builder(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                    '(${_completedOrders['data'][index]['totalRatings'].toString()} ratings)',
                                                    textScaleFactor: textScale,
                                                    style: const TextStyle(
                                                        color: Colors.white,
                                                        fontSize: 12))
            ...
            itemCount: _completedOrders['data'].length),
      ),
    );
  }
}
