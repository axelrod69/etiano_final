...
class CancelledOrdersState extends State<CancelledOrders> {
  final Map<String, dynamic> _cancelledOrders = {
    'data': [
      {
        'id': 1,
        'name': 'Pizza Corner',
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: ListView.builder(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                    '(${_cancelledOrders['data'][index]['totalRatings'].toString()} ratings)',
                                                    textScaleFactor: textScale,
                                                    style: const TextStyle(
                                                        color: Colors.white,
                                                        fontSize: 12))
            ...
            itemCount: _cancelledOrders['data'].length),
      ),
    );
  }
}
