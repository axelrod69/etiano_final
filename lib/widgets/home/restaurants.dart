...
class RestaurantsState extends State<Restaurants> {
  ...
  void didChangeDependencies() {
    ...
    Provider.of<PopularRestaurantProvider>(context).fetchRestaurants();
  }
      ...
      child: ListView.builder(
        itemBuilder: (context, index) => InkWell(
          onTap: () => Navigator.of(context)
            ...
            'numberOfRatings': _restaurants["data"][index]["numberOfRatings"]
          }),
          child: Container(
            width: double.infinity,
            height: height * 0.14,
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        provider['data']['data'][index]['restaurant_name'],
        ...
        itemCount: _restaurants["data"].length,
      ),
    );
  }
}
